...
1. Make sure you have dynamixel_sdk installed by cloning
https://github.com/ROBOTIS-GIT/DynamixelSDK, opening the python directory, and
running `pip install .`.
2. In config.json, set the usb_port to the name of the USB port that the U2D2
module is connected to.
3. Connect the U2D2 USB converter module to the robot, to a power outlet, and
